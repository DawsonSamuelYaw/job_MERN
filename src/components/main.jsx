...
const Main = () => {
  return (
    <div className="main font-[poppins] flex flex-col-reverse md:flex-row items-center justify-around bg-gradient-to-r from-[#4F46E5] to-[#60A5FA] p-8 md:p-16 text-white">
      {/* Left Container */}
      ...
      <div className="relative md:p-14 rounded-[2rem] shadow-lg text-white">
        ...
        <div className="flex justify-center relative">
          <img
            ...
            className="rounded-[2rem] w-full max-w-md" // Responsive image
          />
        </div>

        {/* Floating Notification Boxes */}
        <div className="absolute top-[60px] left-[50px] bg-white text-black p-3 rounded-lg shadow-md text-sm max-w-xs">
        ...
        <div className="absolute bottom-4 left-8 bg-white text-black p-3 rounded-lg shadow-md text-sm max-w-xs">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <button className="bg-pink-500 text-white px-3 py-1 rounded-full mt-1 text-xs font-medium hover:bg-pink-600 transition duration-200">
                Join Now
              </button>
            </div>
          </div>
